...
<body>
	...
	<div class="banner">
		<div class="banner-content">
			<p>Shop</p>
			<a href="${base }/">Home </a><i class="fas fa-chevron-right"></i><span>${cateName }</span>
		</div>
	</div>
	<div class="products">
		<div class="products1">
			<div class="List-products">
				...
				<div class="list-product11">
					...
					<input type="hidden" value="${category_id }" id="cate_ID">
					<input type="hidden" value="${cateSeo }" id="cate_seo">
			...
			<div class="Toc-product" id="toc">
				...
				<sf:form action="${base }/category/${cateSeo}" method="GET"
					...
					<c:choose>
						<c:when test="${category_id!=0 }">
							<c:if test="${fullChildrenOfCate!=null }">
								<sf:select disabled="false" path="category_id"
									name="category_id" id="category_id">
									<sf:options items="${fullChildrenOfCate }" itemValue="id"
										itemLabel="name" />
								</sf:select>
								<br>
								<br>
