...
<body>
	...
	<div class="banner">
		<div class="banner-content">
			<p>Blog</p>
			<a href="${base }/">Home </a><i class="fas fa-chevron-right"></i><span>Blog</span>
		</div>
	</div>
	<div class="blogs">
		<div class="blogs1">
			<div class="List-blogs">
				...
				<input type="hidden" value="${totalPage }" id="totalPage"> <input
					type="hidden" value="${curPage }" id="curPage">
				<div class="all-blogs" id="all-blogs">
					<c:forEach var="blog" items="${blogs }">
						<div class="all-blogs1">
							...
							<a href="${base }/blogs/tag/${blog.tag}" class="tag">${blog.tag}</a>
							<br>
							<p class="title">
							...
							<div class="author">
								<div class="author1">
									...
									<p>
										<i class="fas fa-user"></i> <span >${blog.author}</span>
									</p>
									<%-- </c:if>
									</c:forEach> --%>
								</div>
		...
		$(document)
				.on(
						...
						function() {
							...
							window.history.pushState(null, null, "/blogs?page="
									+ (page + 1));
