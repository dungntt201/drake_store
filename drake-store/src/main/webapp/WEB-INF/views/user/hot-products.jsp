...
<body>
	...
	<div class="banner">
		<div class="banner-content">
			<p>Hot Products</p>
			<a href="${base }/">Home </a><i class="fas fa-chevron-right"></i><span>Hot
				Products</span>
		</div>
	</div>
	<div class="products">
		<div class="products1">
			<div class="List-products">
				...
				<div class="list-product11">
					...
					<input type="hidden" value="${is_hot }" id="HOT">
			...
			<div class="Toc-product" id="toc">
				...
				<sf:form action="${base }/san-pham-hot" method="GET"
